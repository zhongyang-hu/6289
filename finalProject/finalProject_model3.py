...
from finalProject import balancedpreprocessor
...
xtrain,ytrain,xtest,ytest,  tokenizer, wordvectors=balancedpreprocessor(data,mag,40)
...
t=time.time()
modelcheck = ModelCheckpoint('model3.h5', monitor='val_sparse_categorical_accuracy', mode='max', verbose=1, save_best_only=True)
